...
Cypress.Commands.add("ssoLogin", () => {
  ...
  const loginUrl = "https://authgateway1-dev.entsiam.uhg.com/as/.../authorization.ping";

  // Step 1: Visit the URL using auth option instead of inline credentials
  cy.visit(loginUrl, {
    auth: {
      username: basicUser,
      password: basicPass,
